...
fn testnet_genesis(
	...
	steam_runtime::GenesisConfig {
		...
		operator_membership_eave: OperatorMembershipEaveConfig {
			members: vec![root_key.clone()],
			phantom: Default::default(),
		},
