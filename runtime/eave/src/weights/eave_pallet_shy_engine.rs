//! Autogenerated weights for eave_pallet_shy_engine
//!
...
/// Weight functions for eave_pallet_shy_engine.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> eave_pallet_shy_engine::WeightInfo for WeightInfo<T> {
