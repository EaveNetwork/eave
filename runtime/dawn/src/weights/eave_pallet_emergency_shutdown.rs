//! Autogenerated weights for eave_pallet_emergency_shutdown
//!
...
/// Weight functions for eave_pallet_emergency_shutdown.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> eave_pallet_emergency_shutdown::WeightInfo for WeightInfo<T> {
