//! Autogenerated weights for eave_pallet_auction_manager
//!
...
/// Weight functions for eave_pallet_auction_manager.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> eave_pallet_auction_manager::WeightInfo for WeightInfo<T> {
