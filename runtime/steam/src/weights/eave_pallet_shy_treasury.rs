//! Autogenerated weights for eave_pallet_shy_treasury
//!
...
/// Weight functions for eave_pallet_shy_treasury.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> eave_pallet_shy_treasury::WeightInfo for WeightInfo<T> {
