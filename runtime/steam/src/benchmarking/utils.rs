...
pub fn set_susd_balance(who: &AccountId, balance: Balance) {
	set_balance(CurrencyId::Token(TokenSymbol::EUSD), who, balance)
}

pub fn set_eave_balance(who: &AccountId, balance: Balance) {
	set_balance(CurrencyId::Token(TokenSymbol::EAVE), who, balance)
}
