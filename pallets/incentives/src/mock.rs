...
use eave_primitives::TokenSymbol;
use sp_core::H256;
use sp_runtime::{testing::Header, traits::IdentityLookup};
use sp_std::cell::RefCell;
pub use eave_pallet_support::{SHYTreasury, DEXManager, Price, Ratio};
...
pub const BTC_EUSD_LP: CurrencyId = CurrencyId::DEXShare(TokenSymbol::XBTC, TokenSymbol::EUSD);
pub const DOT_EUSD_LP: CurrencyId = CurrencyId::DEXShare(TokenSymbol::DOT, TokenSymbol::EUSD);
...
impl SHYTreasury<AccountId> for MockSHYTreasury {
	...
	fn issue_debit(who: &AccountId, debit: Balance, _: bool) -> DispatchResult {
		TokensModule::deposit(EAVE, who, debit)
	}
...
parameter_types! {
	...
	pub const SlipIncentivePool: AccountId = 12;
	pub const AccumulatePeriod: BlockNumber = 10;
	pub const IncentiveCurrencyId: CurrencyId = EAVE;
	pub const SavingCurrencyId: CurrencyId = EUSD;
	pub const IncentivesModuleId: ModuleId = ModuleId(*b"eave/inct");
}
...
impl Config for Runtime {
	...
	type SlipIncentivePool = SlipIncentivePool;
