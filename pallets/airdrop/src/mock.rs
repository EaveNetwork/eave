...
pub const EAVE: AirDropCurrencyId = AirDropCurrencyId::EAVE;
pub const BEAM: AirDropCurrencyId = AirDropCurrencyId::BEAM;
...
impl ExtBuilder {
	pub fn build(self) -> sp_io::TestExternalities {
		...
		airdrop::GenesisConfig::<Runtime> {
			airdrop_accounts: vec![(CHARLIE, BEAM, 100), (CHARLIE, BEAM, 50), (CHARLIE, EAVE, 80)],
		}
