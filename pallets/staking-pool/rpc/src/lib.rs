...
use eave_pallet_staking_pool_rpc_runtime_api::BalanceInfo;
use eave_pallet_support::ExchangeRate;
...
pub use eave_pallet_staking_pool_rpc_runtime_api::StakingPoolApi as StakingPoolRuntimeApi;
