...
//! process and feed prices for Eave. Process include:
...
use eave_primitives::{currency::GetDecimals, Balance, CurrencyId};
use sp_runtime::{
	traits::{CheckedDiv, CheckedMul},
	FixedPointNumber,
};
use eave_pallet_support::{DEXManager, ExchangeRateProvider, Price, PriceProvider};
...
pub mod module {
	...
	pub trait Config: frame_system::Config {
		...
		#[pallet::constant]
		/// The stable currency id, it should be EUSD in Eave.
		type GetStableCurrencyId: Get<CurrencyId>;

		#[pallet::constant]
		/// The fixed prices of stable currency, it should be 1 USD in Eave.
		type StableCurrencyFixedPrice: Get<Price>;

		#[pallet::constant]
		/// The staking currency id, it should be DOT in Eave.
		type GetStakingCurrencyId: Get<CurrencyId>;

		#[pallet::constant]
		/// The liquid currency id, it should be LDOT in Eave.
