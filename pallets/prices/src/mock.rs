...
pub const LP_BTC_EUSD: CurrencyId = CurrencyId::DEXShare(TokenSymbol::XBTC, TokenSymbol::EUSD);
pub const LP_EUSD_DOT: CurrencyId = CurrencyId::DEXShare(TokenSymbol::EUSD, TokenSymbol::DOT);
