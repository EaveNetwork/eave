...
use eave_primitives::{AuctionId, Balance, CurrencyId};
use sp_runtime::{
	offchain::{
...
use sp_std::prelude::*;
use eave_pallet_support::{AuctionManager, SHYTreasury, SHYTreasuryExtended, DEXManager, EmergencyShutdown, PriceProvider, Rate};
...
pub const OFFCHAIN_WORKER_DATA: &[u8] = b"eave/auction-manager/data/";
pub const OFFCHAIN_WORKER_LOCK: &[u8] = b"eave/auction-manager/lock/";
pub const OFFCHAIN_WORKER_MAX_ITERATIONS: &[u8] = b"eave/auction-manager/max-iterations/";
