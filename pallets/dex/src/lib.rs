...
//! ## Overview
//!
//! Built-in decentralized exchange modules in Eave network, the swap
//! mechanism refers to the design of Uniswap V2. In addition to being used for
//! trading, DEX also participates in SHY liquidation, which is faster than
...
//! additional reward for its participation in the SHY liquidation.
...
use eave_primitives::{Balance, CurrencyId, TradingPair};
use sp_core::U256;
use sp_runtime::{
...
use eave_pallet_support::{DEXIncentives, DEXManager, Price, Ratio};
