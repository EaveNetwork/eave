...
pub const EUSD_XBTC_PAIR: TradingPair = TradingPair(EUSD, XBTC);
pub const EUSD_DOT_PAIR: TradingPair = TradingPair(EUSD, DOT);
...
parameter_types! {
	...
	pub const DEXModuleId: ModuleId = ModuleId(*b"eave/dexm");
}
	...
	fn default() -> Self {
		Self {
			endowed_accounts: vec![
				(ALICE, EUSD, 1_000_000_000_000_000_000u128),
				(BOB, EUSD, 1_000_000_000_000_000_000u128),
...
impl ExtBuilder {
	...
	pub fn initialize_enabled_trading_pairs(mut self) -> Self {
		self.initial_enabled_trading_pairs = vec![EUSD_DOT_PAIR, EUSD_XBTC_PAIR, DOT_XBTC_PAIR];
		self
	}
	...
	pub fn initialize_added_liquidity_pools(mut self, who: AccountId) -> Self {
		self.initial_added_liquidity_pools = vec![(
			who,
			vec![
				(EUSD_DOT_PAIR, (1_000_000u128, 2_000_000u128)),
				(EUSD_XBTC_PAIR, (1_000_000u128, 2_000_000u128)),
