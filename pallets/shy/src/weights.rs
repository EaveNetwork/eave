...
//! Autogenerated weights for pallet_shy
//!
...
// --heap-pages=4096
// --output=./modules/shy/src/weights.rs
...
/// Weight functions needed for module_shy.
...
/// Weights for module_shy using the Eave node and recommended hardware.
