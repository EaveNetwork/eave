...
use eave_pallet_loans::Position;
...
pub const OFFCHAIN_WORKER_DATA: &[u8] = b"eavela/shy-engine/data/";
pub const OFFCHAIN_WORKER_LOCK: &[u8] = b"eavela/shy-engine/lock/";
pub const OFFCHAIN_WORKER_MAX_ITERATIONS: &[u8] = b"eavela/shy-engine/max-iterations/";
pub const LOCK_DURATION: u64 = 100;
pub const DEFAULT_MAX_ITERATIONS: u32 = 1000;

pub type LoansOf<T> = eave_pallet_loans::Module<T>;
...
pub mod module {
	...
	#[pallet::config]
	pub trait Config: frame_system::Config + eave_pallet_loans::Config + SendTransactionTypes<Call<Self>> {
...
impl<T: Config> Pallet<T> {
	...
	fn _offchain_worker() -> Result<(), OffchainErr> {
		...
		let mut map_iterator = <eave_pallet_loans::Positions<T> as IterableStorageDoubleMapExtended<_, _, _>>::iter_prefix(
			currency_id,
			max_iterations,
			start_key.clone(),
		);
